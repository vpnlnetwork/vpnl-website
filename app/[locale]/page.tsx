  ...
  const joinActions = [
    {
      ...
      href: "https://github.com/vpnlnetwork/vpnl",
      className: "text-primary hover:text-primary-hover",
      description: "Contribute code, issues, and ideas to the VPNL project.",
      eventName: "GitHub",
    },
    {
      Svg: Twitter,
      ...
      className: "text-accent-a hover:text-accent-a-hover",
      description: "Join our community chat on Telegram.",
      eventName: "Telegram",
    },
    {
      Svg: EthGlyphIcon,
      ...
      href: "https://github.com/vpnlnetwork/vpnl#readme",
      className: "text-accent-c hover:text-accent-c-hover",
      description: "Read the docs and learn how to integrate VPNL.",
    ...
    },
    {
      ...
      className: "text-accent-b hover:text-accent-b-hover",
      description: "Reach out to the VPNL team via email.",
      eventName: "Contact",
    },
  ]
