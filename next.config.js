  ...
  nextConfig = {
    ...
    async redirects() {
      return [
        ...
        { source: '/roadmap/:path*', destination: '/', permanent: false },
        { source: '/staking/:path*', destination: '/', permanent: false },
        { source: '/layer-2/:path*', destination: '/', permanent: false },
        { source: '/learn/:path*', destination: '/', permanent: false },
        { source: '/enterprise/:path*', destination: '/', permanent: false },
        { source: '/bug-bounty/:path*', destination: '/', permanent: false },
        { source: '/wallets/:path*', destination: '/', permanent: false },
        { source: '/get-eth/:path*', destination: '/', permanent: false },
        { source: '/gas/:path*', destination: '/', permanent: false },
        { source: '/run-a-node/:path*', destination: '/', permanent: false },
        { source: '/stablecoins/:path*', destination: '/', permanent: false },
        { source: '/collectibles/:path*', destination: '/', permanent: false },
        { source: '/apps/:path*', destination: '/', permanent: false },
        { source: '/assets/:path*', destination: '/', permanent: false },
        { source: '/resources/:path*', destination: '/', permanent: false },
        { source: '/quizzes/:path*', destination: '/', permanent: false },
        { source: '/start/:path*', destination: '/', permanent: false },
        { source: '/founders/:path*', destination: '/', permanent: false },
        { source: '/eth/:path*', destination: '/', permanent: false },
        { source: '/10years/:path*', destination: '/', permanent: false },
        { source: '/what-is-ethereum/:path*', destination: '/', permanent: false },
        { source: '/what-is-the-ethereum-network/:path*', destination: '/', permanent: false },
